<template>
    <div class="orderPageBigBox">
        ...
        <div class="orderBoxMight">
            ...
            <div class="orderBoxMightDeliveryBox">
                <div class="orderBoxMightDeliveryLeft">
                    <div class="orderBoxMightDeliveryAddress">秋菊超市</div>
                    <div class="orderBoxMightDeliveryName">
                        <span class="orderBoxMightDeliveryNickname">李小慧</span>
                        <span class="orderBoxMightDeliveryPhone">12343297678</span>
                    </div>
                </div>
        ...
        <div class="orderBoxBottom">
            <div class="orderBoxBottomTitle">古茗</div>
            <div class="orderBoxBottomDishes">
                <div class="orderBoxBottomDishBox">
                    <div class="orderBoxBottomDishLeft">
                        <div><img src="http://localhost:8080/upload/dashu.jpg" class="orderBoxBottomDishLeftImg"></div>
                    </div>
                    <div class="orderBoxBottomDishRight">
                        <div class="orderBoxBottomDishRightName">大叔奶茶</div>
                        <div class="orderBoxBottomDishRightFlavor">大/不去料</div>
